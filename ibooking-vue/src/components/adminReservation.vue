<template>
  <div>
    ...
    <div class="reservationTable">
      ...
      <p class="info1">当前学生学号：{{this.$store.state.stuNum}}</p>
  ...
  export default {
    data () {
      ...
      getStatus (status) {
        ...
        console.log(this.reservationTable[row].status)
        axios.post('/api/admin/reserveCancel', {
        ...
        return this.reservationTable[row].status !== "预约成功待签到"
